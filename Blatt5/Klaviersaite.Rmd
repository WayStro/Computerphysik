...
Für eine ungedämpfte Simulation, ist die Dämpfung der Amplituden in einer Welle (etwas) geringer. Hier wäre unserer Meinung nach ein deutlicherer Unterschied im Vergleich zur gedämpften Simuation zu erwarten. Das durch die FFT estellte Spektrum ändert sich nicht erkennbar, was eigentlich nicht zu erwarten wäre. Es deckt sich aber insofern mit der Simulation, da sich diese eben auch (fast) nicht verändert hat. Ob dies nun an mangelnder Stabilität liegt oder ein anderer Fehler vorliegt, lässt sich nicht mit Sicherheit sagen. Letzteres erscheint jedoch wahrscheinlicher. 
...
Leider ist das Gesamtergebnis eher schlecht zu bewerten. Lediglich bei der Simulation des Hammerschlages gelang es uns (unserer Meinung nach) sinnvolle Ergebnisse zuliefern, wobei der Vergleich mit der ungedämpften Simulation auch hier Fragen aufwirft. \newline
Die FFT und anschließende Ordnung der Werte lieferte nicht die eigentlich deutlich erkennbaren Obertöne. \newline
Der Vergleich mit der ungedämpften Simulation bestätigt unsere Vermutung, dass der Code/die Herangehensweise mit Fehlern behaftet ist und lässt keine direkte Auskunft über die Stabilität zu.\newline
...
\textit{Wikipedia Oberton, https://de.wikipedia.org/wiki/Oberton#Erl%C3%A4uterungsbeispiel:_Kammerton_a1_und_die_ersten_f%C3%BCnf_Harmonischen ,Stand: 6.7.2021}
