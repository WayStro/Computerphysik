...
plot(1:steps, u[2,], "l", col=rainbow(6)[1])
...
a_list <- list(sort(n, FFT(u[,200], r)))


for (i in c(1:60)){
  temp <- sort(n, FFT(u[,200+i], r))
...
plot(1/seq(0, times, length.out=2^r), Re(unlist(a_list[1])), "l", col="red", ylim=c(0.,0.02))


for (i in c(1:60)){
  
  lines(1/seq(0, times, length.out=2^r), Re(unlist(a_list[1+i])), col=rainbow(length(c(1:60)))[i])
