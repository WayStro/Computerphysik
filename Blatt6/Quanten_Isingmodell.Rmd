...
Letzlich ließen sich Grundzustände, die jeweiligen Energien und die Magnetisierung gut für die verschiedenen Kopplungen und Anzahl an Gitterpunkten N darstellen. Für N=10 benötigt unser Verfahren jedoch ausgesprochen lange. Leider mussten wir auf die Eigenfunktion von R zurückgreifen, um den niedrigsten Eigenwert stabil zu bestimmen (analog die Eigenvektoren). 
